...
export default function AdDetailPage() {
  ...
  const seoTitle = `${ad.copy} — ${ad.advertiserName} | ChatGPT Ads Library`;
  const seoDescription =
    ad.description ||
    `${ad.advertiserName} ad running on ChatGPT. Published ${formatDate(ad.publishedDate)}.`;
    ...
    <>
      ...
      <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
          {ad.mediaUrl ? (
            <img src={ad.mediaUrl} alt={ad.copy} className="h-auto w-full object-contain" />
          ) : (
